...
<body>
  ...
  <form action="acceso.php" method=get>
    <fieldset>
      ...
      <a href="http://192.168.1.11/listado.php"> Listado de identificadores </a>
    </fieldset>
  </form>
  ...
  <ul>
    ...
    <li>
      Repositorio <a href="https://github.com/germaaan/PRACTICA_03" > PRACTICA_03 </a> con el código de la aplicación.
    </li>
    <li>
